...
from awslabs.aws_cv_mcp_server.server import (
...
class TestMcpGenerateDiagram:
    ...
    @pytest.mark.asyncio
    @patch('awslabs.aws_cv_mcp_server.server.generate_diagram')
...
class TestMcpGetDiagramExamples:
    ...
    @pytest.mark.asyncio
    @patch('awslabs.aws_cv_mcp_server.server.get_diagram_examples')
...
class TestMcpListDiagramIcons:
    ...
    @pytest.mark.asyncio
    @patch('awslabs.aws_cv_mcp_server.server.list_diagram_icons')
